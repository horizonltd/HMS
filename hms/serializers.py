...
from hms.models import Company, CompanyBank, Medicine, MedicalDetails, Employee, Customer, Bill, \
...
class CompanyBankSerializer(serializers.ModelSerializer):
    ...
    # Returning related primaryKey data;
    # Also depth = 1 can be use to represent this.
...
class SimpleMedicalDetailsSerializer(serializers.ModelSerializer):
    class Meta:
        model = MedicalDetails
        fields = "__all__"
